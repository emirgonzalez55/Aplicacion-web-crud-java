    ...
    <div class="table-responsive">
		...
		<th>Eliminar</th>
					...
					<tr>
						...
						<td class='col-md-1'><a class="btn btn-secondary" href="editargpu.jsp?id=<%= resultado.getString(1)%>&marca=<%= resultado.getString(2)%>&modelo=<%= resultado.getString(3)%>&rendimiento=<%= resultado.getString(4)%>">Editar</a></td>
                                                <td class='col-md-2'><a class="btn btn-danger" href="eliminargpu.jsp?id=<%= resultado.getString(1)%>">Eliminar</a></td>
					</tr>
