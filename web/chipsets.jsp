...
<body>
    ...
    <a class='btn btn-primary boton'  href='addchipsets.jsp'>Añadir chipset</a>
		...
		<th>Rendimiento</th>
                                        ...
                                        <%
                                            ...
                                            resultado=sentenciaPreparada.executeQuery("SELECT * FROM chipsets ");
					...
					<tr>
						...
						<td class='col-md-3 themed-styles-col'><a class="btn btn-secondary" href="editarchipsets.jsp?id=<%= resultado.getString(1)%>&marca=<%= resultado.getString(2)%>&modelo=<%= resultado.getString(3)%>&rendimiento=<%= resultado.getString(4)%>">Editar</a></td>
                                                <td class='col-md-3 themed-styles-col'><a class="btn btn-danger" href="eliminarchipsets.jsp?id=<%= resultado.getString(1)%>">Eliminar</a></td>
					</tr>
